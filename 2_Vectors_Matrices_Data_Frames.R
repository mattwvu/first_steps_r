...
# Vector Recycling if two vectors that are unmatched in length, R will repeat the shorter vector until the two vectors are equal in length
...
# Matrices are two-dimensional vectors. Like vectors they can only contain one class of value.
   ...
   # CBIND and RBIND
    ...
    # Naming Columns and Rows
            ...
            pressElection <- c(232, 306, 304, 227, 206, 332, 173, 365, 286, 251, 271, 266, 159, 379, 168, 370, 426, 111, 525, 14, 489, 49) #create a vector of electoral college returns
            pressElection
            ...
            rownames(ec.mat) <- c("2020", "2016", "2012", "2008", "2004", "2000", "1996", "1992", "1988", "1984", "1980")
            ec.mat
            typeof(ec.mat)
